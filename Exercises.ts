...
let titlecase : string = Personname.split(' ').map(name => name.charAt(0).toUpperCase()+name.slice(1).toLowerCase()).join(' ')
...
//Answer # 6
const Governor : String = '    \n\t Governor Sindh Kamran Tassori\t\n    '
console.log(Governor)

//Without white spacing

const GovernorSind : String = Governor.trim()
...
let Fahad :String[] = ['Hassan','Imran', 'Sohail'];
...
let Fahad1 :String[] = ['Hassan','Imran', 'Sohail'];

const Khan1 : string = 'Welcome to Typescript Class: '
...
let Guest_list: String[] = ['Hassan', 'Imran', 'Afzal']
...
let guest_List1 : String [] = ['Imran', 'Asif', 'Zardari']
...
for(let i=0; i<guest_List1.length; i++){
   ...
   let PakTeam: String []= ['Shahid', 'Imran', 'Razzak', 'Babar','Wasim']

   let newplayer : String []= ['Shoaib', 'Sohail', 'Naseem']
   let notplay : String []= ['Shahid', 'Imran', 'Razzak', 'Babar','Wasim'] 
   ...
   let WorldXi : String []=['Saeed', 'Gilcrist', 'Ricky', 'Kalis', 'Wasim'] 
   WorldXi.push('Aamir')

   let Reserve: String[]=['Sachin', 'Brian', 'Shoaib', 'McGrath', 'Shane']

   let notP : String[]=['Saeed', 'Gilcrist', 'Ricky', 'Kalis', 'Wasim']
   notP.push('Aamir')
...
guestlist2.forEach(oneguest=> console.log(`Salam ${oneguest}, would you like to dinner wiht me`))
  ...
  let newprog : String [] = ['Hassan', 'Ali', 'Raheel', 'Farrukh','Asif']
...
let places : string [] = ['Karachi', 'Islamabad', 'Agra', 'Bihar', 'lahore'];
...
else {console.log ("Sorry, you earned 0 Points")}
...
usernames1.forEach(oneUser => {
    ...
    else{console.log(`Hello ${oneUser}, thanks you for logging in again`)}
})
...
console.log("-----------------------------------------");
let oNums:number[] = [1,2,3,4,5,6,7,8,9];
...
let Pizzas: string [] = ["Fajita", "BBQ", "Maxica"];
...
let petAnimal:string[] = ["Horse", "Cat", "Parrot"]
...
function makeAlbum(artist_name: string, album_title: string, track?: number){
...
let magician1 : string[] = ["Magician -1", "Magician - 2", "Magician - 3", "Magician - 4"]

function make_greet(magicianArry:string[]){
...
let magician2 : string[] = ["Magician -1", "Magician - 2", "Magician - 3", "Magician - 4"]
...
function make_greet1(magicianArry:string[]){
